...
whole number of seconds, a non-positive count, or a cache capacity that is not
a positive byte count) refuses to boot with every problem listed, not just the
first.
